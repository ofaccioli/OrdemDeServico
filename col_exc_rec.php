...
<html>
    ...
    <?php
		 ...
		 foreach( $cod as $remove_item ){
				...
				$sql = "delete from Colaborador where Cod_Colaborador = ".$remove_item;
    ...
    <div id="conteudo">
    	...
    	<h1>Os Colaboradores selecionados foram deletados com sucesso </h1>
        ...
        <table class="tbprincipal">
            ...
            <tr>
            	<td><a href="col_exc.php"><img src="img/delete_0.png"></a></td>
                <td><a href="col_exc.php">Excluir outro colaborador</a></td>
            </tr>
        </table>
