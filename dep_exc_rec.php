...
<html>
    ...
    <?php
		 ...
		 foreach( $cod as $remove_item ){
				...
				$sql = "delete from Departamento where Cod_departamento = ".$remove_item;
    ...
    <div id="conteudo">
    	...
    	<h1>Os Departamentos selecionados foram deletados com sucesso </h1>
        ...
        <table class="tbprincipal">
            ...
            <tr>
            	<td><a href="dep_exc.php"><img src="img/delete_0.png"></a></td>
                <td><a href="dep_exc.php">Excluir outro departamento</a></td>
            </tr>
        </table>
