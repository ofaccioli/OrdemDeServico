...
$("#campoData2").mask("99/99/9999");
    ...
    <div id="titulo">
        ...
        <a href="os_imp.php" target="_blank" ><img id="printer" src="img/print_0.png" ></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="os_con.php"><img id="voltar" src="img/voltar.png"></a>
    	
        <br>
        
	    <h1>Ordem de Serviço<span class="titulo">N&ordm; <?php echo $cod_ordem; ?>  |  Data: <?php echo $date->format('d/m/Y'); ?></span></h1> 
    </div>
    ...
    <form name="form1" action="os_alt_rec.php" method="post">
        ...
        <h3>Solicitante</h3>
			...
			<tr>
            	<td>
                	Descri&ccedil;&atilde;o do Serviço:
                </td>
			</tr>
            <tr>			
                <td colspan="5">
...
<tr>			
         ...
         <tr>
            ...
            <tr>
            	<td colspan="6">
                	<textarea name="taMateriais" cols="111" rows="5" maxlength="535" readonly="readonly"><?php echo $materiais; ?></textarea>
                </td>
            </tr>
            	<td>
                Data de Inicio:
