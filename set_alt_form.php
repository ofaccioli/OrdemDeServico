...
<html>
  ...
  <script src="//code.jquery.com/ui/1.11.0/jquery-ui.js"></script>
	   ...
	   <?php
		...
		$_SESSION["Cod_setor"] = $_POST["altcodigo"];
		
		$sql = "select * from setor where Cod_setor = ".$_POST["altcodigo"];
    ...
    <form name="form1" action="set_alt_rec.php" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="5">
                	<input type="text" maxlength="50" size="50" name="txtSetor"  value="<?php echo $nome ?>"  />
