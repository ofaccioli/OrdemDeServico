...
<html>
    ...
    <?php
		 ...
		 try{
			 ...
			 $sql = "update setor set  Nome_setor = '$setor' where Cod_setor = $cod";
    ...
    <div id="conteudo">
    	...
    	<h1>O setor foi alterado com sucesso </h1>
        ...
        <table class="tbprincipal">
            ...
            <tr>
            	<td><a href="emp_alt.php"><img src="img/alterar_0.png"></a></td>
                <td><a href="emp_alt.php">Alterar outro setor</a></td>
            </tr>
